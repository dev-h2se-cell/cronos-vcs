...
import { MessageSquare, X, Send, Image as ImageIcon, Sparkles, BrainCircuit, Bot, Loader2 } from 'lucide-react';
...
export const Chatbot: React.FC = () => {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      // Do not add a check for 'typeof process' here, as it will cause the key to be undefined in the browser.
      ...
      let config: any = {
        systemInstruction: "Eres un experto dermatólogo y consultor de la marca 'CHRONOS'. Tu tono es clínico, preciso y sofisticado ('Bio-Tech Luxury'). Responde dudas sobre Chronos-C Shield (Vitamina C), Infinity Retinal y el Protocolo de Longevidad. Sé conciso.",
      };
