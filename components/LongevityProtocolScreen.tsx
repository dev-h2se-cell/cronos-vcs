...
import { ArrowLeft, Star, Sun, Moon, ShieldCheck, Zap, Clock, CheckCircle2, Flame, CreditCard } from 'lucide-react';
...
export const LongevityProtocolScreen: React.FC<Props> = ({ onBack, onAddToCart }) => {
  const [timeLeft, setTimeLeft] = useState(12); // Fake scarcity counter
      ...
      <div className="max-w-2xl mx-auto pb-32">
            ...
            <div className="absolute inset-0 flex">
              ...
              <div className="w-1/2 bg-gradient-to-br from-orange-50 to-orange-100 flex items-center justify-center relative">
                ...
                <div className="w-24 h-48 bg-white/30 backdrop-blur-sm border border-orange-200 rounded-lg transform -rotate-6 translate-x-4 z-10 shadow-lg flex items-center justify-center">
                   <div className="text-[10px] font-bold text-orange-800 rotate-90 whitespace-nowrap">CHRONOS-C</div>
                </div>
              </div>
              {/* Night Side */}
              <div className="w-1/2 bg-gradient-to-bl from-slate-900 to-purple-900 flex items-center justify-center relative">
                ...
                <div className="w-24 h-48 bg-slate-800/80 backdrop-blur-sm border border-purple-500/50 rounded-lg transform rotate-6 -translate-x-4 z-20 shadow-2xl flex items-center justify-center">
                   <div className="text-[10px] font-bold text-purple-200 rotate-90 whitespace-nowrap">INFINITY</div>
                </div>
              </div>
            </div>
            {/* Center Plus */}
            ...
            <div className="relative border-l-2 border-slate-200 ml-6 space-y-10 my-4">
              ...
              <div className="relative pl-8">
                ...
                <p className="text-slate-600 text-sm mt-1">
                  Chronos-C neutraliza radicales libres, UV y contaminación. Evita que tu colágeno se degrade durante el día.
                </p>
              </div>

              {/* PM */}
              <div className="relative pl-8">
                <div className="absolute -left-[9px] top-0 w-4 h-4 bg-purple-600 rounded-full border-2 border-white shadow-sm"></div>
                <h3 className="font-bold text-slate-900 text-lg">10:00 PM • Modo Reparación</h3>
                <p className="text-slate-600 text-sm mt-1">
                  Infinity Retinal acelera la renovación celular mientras duermes. Repara el daño acumulado y suaviza líneas.
                </p>
              </div>
            </div>
        ...
        <section className="px-6 py-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center bg-white p-4 rounded-xl border border-orange-100 shadow-sm">
              ...
              <div className="flex-grow">
                <div className="flex justify-between items-start">
                  <h4 className="font-bold text-slate-900">Chronos-C Shield™</h4>
                  <span className="text-slate-400 line-through text-xs">$45.00</span>
                </div>
                <p className="text-xs text-orange-600 font-medium">Cero Oxidación. Brillo Clínico.</p>
              </div>
            </div>
            ...
            <div className="flex items-center bg-slate-900 p-4 rounded-xl border border-purple-900 shadow-sm text-white">
              ...
              <div className="flex-grow">
                <div className="flex justify-between items-start">
                  <h4 className="font-bold text-white">Infinity Retinal Night</h4>
                  <span className="text-slate-500 line-through text-xs">$52.00</span>
                </div>
                <p className="text-xs text-purple-400 font-medium">11x Más Rápido que Retinol.</p>
              </div>
            </div>

            {/* Item 3 (Free) */}
            <div className="flex items-center bg-green-50 p-4 rounded-xl border-2 border-green-200 shadow-sm relative overflow-hidden">
              <div className="absolute top-2 right-2 bg-green-200 text-green-800 text-[10px] font-bold px-2 py-0.5 rounded-full uppercase">
                Gratis
              </div>
              ...
              <div className="flex-grow">
                <div className="flex justify-between items-start">
                  <h4 className="font-bold text-slate-900">Barrier Lock Cream</h4>
                  <span className="text-slate-400 line-through text-xs">$25.00</span>
                </div>
                <p className="text-xs text-green-600 font-medium">Travel Size. Barrera Blindada.</p>
              </div>
            </div>
            ...
            <div className="flex items-center bg-blue-50 p-4 rounded-xl border-2 border-blue-200 shadow-sm relative overflow-hidden">
              ...
              <div className="flex-grow">
                <div className="flex justify-between items-start">
                  <h4 className="font-bold text-slate-900">Guía Skin Streaming</h4>
                  <span className="text-slate-400 line-through text-xs">$15.00</span>
                </div>
                <p className="text-xs text-blue-600 font-medium">Ahorra $1,000/año en skincare.</p>
              </div>
            </div>
        ...
        <section className="bg-slate-900 rounded-t-3xl p-8 -mx-0 shadow-[0_-10px_40px_rgba(0,0,0,0.3)] relative overflow-hidden">
          ...
          <div className="flex justify-center items-end gap-3 mb-8">
            <span className="text-slate-500 line-through text-xl font-mono decoration-red-500 decoration-2">$137.00</span>
            <span className="text-5xl font-bold text-white tracking-tight">$98.00</span>
          </div>
