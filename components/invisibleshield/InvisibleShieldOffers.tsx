    ...
    <section id="offers" className="scroll-mt-40 pb-20">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-200 hover:border-amber-300 transition-colors shadow-sm flex flex-col justify-between">
          ...
          <Button onClick={() => onAddToCart(invisibleShieldProduct.id, 1)} variant="outline" fullWidth className="border-slate-300 hover:border-amber-500 hover:text-amber-600">
            AÑADIR AL CARRITO
          </Button>
        </div>
        {/* Card 2: Subscription */}
        <div className="bg-amber-50 p-6 rounded-2xl border border-amber-200 shadow-md relative overflow-hidden flex flex-col justify-between">
          ...
          <Button onClick={() => onAddToCart(invisibleShieldProduct.id, 1)} fullWidth className="bg-amber-500 hover:bg-amber-600 border-0 text-white">
            SUSCRIBIRSE
          </Button>
        </div>
        ...
        <div className="bg-gradient-to-br from-white to-orange-50 p-6 rounded-2xl border-2 border-orange-200 shadow-xl flex flex-col justify-between md:col-span-2 relative">
          ...
          <div className="flex flex-col md:flex-row gap-6 items-center">
            ...
            <div className="w-full md:w-auto flex gap-2">
              ...
              <Button onClick={() => onAddToCart(protocoloDia.id, 1)} className="bg-orange-600 hover:bg-orange-700 text-white shadow-lg shadow-orange-200 flex-grow">
                COMPRAR DÚO
              </Button>
            </div>
          </div>
